          ...
          <div className="flex-grow flex flex-wrap justify-center -mb-10 md:mt-0 mt-10 text-center">
            <div className="lg:w-1/3 md:w-1/2 w-full px-4">
              ...
              <div className="flex flex-col justify-center items-center md:items-start gap-2 mb-10 text-sm">
                ...
                <a href="/#" target="_blank" className="transition-colors hover:text-foreground text-foreground/70">
                  Affiliates
                </a>
              </div>
            </div>
            ...
            <div className="lg:w-1/3 md:w-1/2 w-full px-4">
              ...
              <div className="flex flex-col justify-center items-center md:items-start gap-2 mb-10 text-sm">
                <Link href="/terms" className="transition-colors hover:text-foreground text-foreground/70">
                  Terms of services
                </Link>
                <Link href="/privacy-policy" className="transition-colors hover:text-foreground text-foreground/70">
                  Privacy policy
                </Link>
              </div>
            </div>
